...
const ServiceSurvey = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccessMessage("¡Gracias por tu opinión! Tu feedback nos ayuda a mejorar continuamente.");
      ...
      setErrorMessage("Ocurrió un error al enviar tu opinión. Por favor, intenta nuevamente.");
    } finally {
      setIsLoading(false);
    }
  };
          ...
          <div className="p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 leading-relaxed max-w-2xl mx-auto">
                Tu opinión es muy valiosa para nosotros. Ayúdanos a mejorar nuestros servicios compartiendo tu experiencia de alojamiento.
              </p>
              {reference && (
                <div className="mt-4 inline-block bg-amber-50 border border-amber-200 rounded-lg px-4 py-2">
                  <p className="text-sm text-amber-700">
                    <span className="font-medium">Reserva:</span> {reference.split('_')[0]}
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-gradient-to-r from-amber-50 to-yellow-50 border border-amber-200 rounded-xl p-4 mb-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-amber-800">Encuesta Anónima y Segura</p>
                  <p className="text-xs text-amber-700">Tus respuestas nos ayudan a brindarte un mejor servicio en futuras visitas</p>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-amber-50 to-yellow-50 border-2 border-amber-200 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800">Calificación General</h3>
                </div>
                <StarRating
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                  <StarRating
                    ...
                    onRatingChange={(rating) => handleRatingChange('facilitiesRating', rating)}
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  {[
                    { value: 'definitely', label: 'Definitivamente sí', color: 'green' },
                    { value: 'probably', label: 'Probablemente sí', color: 'amber' },
                    { value: 'maybe', label: 'Tal vez', color: 'gray' },
                    { value: 'probably_not', label: 'Probablemente no', color: 'orange' },
                    { value: 'definitely_not', label: 'Definitivamente no', color: 'red' }
                  ].map((option) => (
              ...
              <div className="pt-6">
                ...
                {formData.overallRating === 0 && (
                  <p className="text-center text-sm text-amber-600 mt-2 font-medium">
                    Por favor, proporciona una calificación general para continuar
                  </p>
                )}
              </div>
            </form>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100">
              <p className="text-center text-xs text-gray-500 leading-relaxed">
                ...
                <br />
                <span className="text-amber-600 font-medium">Tu feedback es fundamental para nuestro crecimiento.</span>
              </p>
            </div>
          </div>
        </div>
